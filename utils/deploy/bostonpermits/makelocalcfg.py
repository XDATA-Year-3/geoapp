...
panels: [
  {"key":"permit", "name":"permit", "names":"permits", "capname":"Permit", "capnames":"Permits", "title":"Boston Permits", "description":"Building permits in Boston", "controls":[
    {"key":"permittypedescr_search", "type":"combobox", "name": "Permit Type", "title": "Permit types include: Short Form, Electrical, Plumbing, Gas, Low Voltage, Long Form/Alteration, Fire Alarms, Certificate of Occupancy, Electrical Temporary Service, Excavation, Amendment, Erect/New Construction, Use of Premises, and Foundation", "options": [
    ...
    {"key":"occupancytype_search", "type":"combobox", "name": "Occupancy Type", "title": "Occupany types include: Comm, 1-<number>FAM, <number>Unit, Multi, Other, Mixed, 7More, VacLd.  The <number> is in range of 1-7.", "options": [
    ...
    {"key":"description_search", "type":"combobox", "name": "Description", "title": "Common values include Electrical, Plumbing, Gas, Rennovations, Fire Alarm, Roofing, Low Voltage, Interior, Exterior, Insulation, Solar, Demolition, Signs, Siding", "options": [
  ...
  {"key":"crime", "name":"crime", "names":"crimes", "capname":"Crime", "capnames":"Crimes", "title":"Boston Crimes", "description":"Crimes in Boston", "controls":[
    {"key":"category_search", "type":"combobox", "name": "Incident Type", "title": "Common incident types are Larceny, Assult, MedAssist, MVAcc (Motor Vehicle Accient), Vandalism, Drug Chargesm Fraud, PropLost, Towed, Burglary, Robbery, and Auto Theft", "options": [
  ...
  {"key":"violation", "name":"violation", "names":"violations", "capname":"Violation", "capnames":"Violations", "title":"Boston Violations", "description":"Violations in Boston", "controls":[
    {"key":"category_search", "type":"combobox", "name": "Description", "title": "Common violations involve trash, weeds, failing to clear snow from sidewalks, illedgal dumping, illegal parking, unregistered vehicles, graffiti, and maintenance issues.", "options": [
      ...
      {"value": "maintain struct", "text": "Structural maintainence"},
      {"value": "Re-inspect", "text": "Failure to Re-inspect"},
      {"value": "Graffiti", "text": "Graffiti"},
      {"value": "maintain.*facilit", "text": "Facilities maintainence"},
